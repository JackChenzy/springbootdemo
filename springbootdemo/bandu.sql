...
CREATE TABLE `business_dynamic` (
  ...
  `img_urls` varchar(2000) DEFAULT NULL COMMENT '动态图片urls',
  `create_time` datetime DEFAULT NULL COMMENT '发布时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  `state` int(11) DEFAULT NULL COMMENT '状态',
  `goods` int(11) DEFAULT NULL COMMENT '点赞数',
  `comment` int(11) DEFAULT NULL COMMENT '评论数',
  `collection` int(11) DEFAULT NULL COMMENT '被收藏数',
...
-- ----------------------------
-- Table structure for business_dynamic_collection
-- ----------------------------
DROP TABLE IF EXISTS `business_dynamic_collection`;
CREATE TABLE `business_dynamic_collection` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '动态收藏表id',
  `dyn_id` bigint(20) DEFAULT NULL,
  `dynamic_id` bigint(20) DEFAULT NULL COMMENT '动态表id',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
...
-- ----------------------------
-- Records of business_dynamic_collection
-- ----------------------------

-- ----------------------------
-- Table structure for business_dynamic_comment
-- ----------------------------
DROP TABLE IF EXISTS `business_dynamic_comment`;
CREATE TABLE `business_dynamic_comment` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of business_dynamic_comment
-- ----------------------------

-- ----------------------------
-- Table structure for business_feedback
-- ----------------------------
DROP TABLE IF EXISTS `business_feedback`;
CREATE TABLE `business_feedback` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `content` varchar(2000) DEFAULT NULL COMMENT '反馈内容',
  `create_time` datetime DEFAULT NULL COMMENT '反馈时间',
  `state` int(11) DEFAULT NULL COMMENT '状态0正常，1删除',
  `success_time` datetime DEFAULT NULL COMMENT '解决时间',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户反馈表';

-- ----------------------------
-- Records of business_feedback
-- ----------------------------

-- ----------------------------
-- Table structure for business_follow
-- ----------------------------
DROP TABLE IF EXISTS `business_follow`;
CREATE TABLE `business_follow` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '关注主表id',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  `follow_time` datetime DEFAULT NULL COMMENT '关注时间',
  `state` int(11) DEFAULT NULL COMMENT '状态0正常1删除',
  `follow_id` bigint(20) DEFAULT NULL COMMENT '被关注人的id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='关注表';

-- ----------------------------
-- Records of business_follow
-- ----------------------------

-- ----------------------------
-- Table structure for business_good
-- ----------------------------
DROP TABLE IF EXISTS `business_good`;
CREATE TABLE `business_good` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户id',
  `good_id` bigint(20) DEFAULT NULL COMMENT '被赞者id',
  `good_time` datetime DEFAULT NULL COMMENT '点赞时间',
  `dynamic_id` bigint(20) DEFAULT NULL COMMENT '点赞动态id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='点赞表';

-- ----------------------------
-- Records of business_good
-- ----------------------------
...
CREATE TABLE `business_user` (
  ...
  `kick_time` datetime DEFAULT NULL COMMENT '封号时间',
  PRIMARY KEY (`id`)
...
-- Records of sys_file
-- ----------------------------
INSERT INTO `sys_file` VALUES ('142', '0', '/files/fe2fea9f-29db-4119-8926-fc1b823bc57e.png', '2019-09-19 10:10:57');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=690 DEFAULT CHARSET=utf8 COMMENT='系统日志';

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('609', '1', 'admin', '登录', '35', 'com.bootdo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 08:44:37');
INSERT INTO `sys_log` VALUES ('610', '1', 'admin', '请求访问主页', '38', 'com.bootdo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 08:44:37');
INSERT INTO `sys_log` VALUES ('611', '1', 'admin', '请求访问主页', '7', 'com.bootdo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 08:45:14');
INSERT INTO `sys_log` VALUES ('612', '1', 'admin', '登录', '37', 'com.bootdo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 08:47:56');
INSERT INTO `sys_log` VALUES ('613', '1', 'admin', '请求访问主页', '34', 'com.bootdo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 08:47:56');
INSERT INTO `sys_log` VALUES ('614', '1', 'admin', '删除菜单', '14', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:16');
INSERT INTO `sys_log` VALUES ('615', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:22');
INSERT INTO `sys_log` VALUES ('616', '1', 'admin', '删除菜单', '6', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:26');
INSERT INTO `sys_log` VALUES ('617', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:30');
INSERT INTO `sys_log` VALUES ('618', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:34');
INSERT INTO `sys_log` VALUES ('619', '1', 'admin', '删除菜单', '4', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:36');
INSERT INTO `sys_log` VALUES ('620', '1', 'admin', '删除菜单', '14', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:42');
INSERT INTO `sys_log` VALUES ('621', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:48');
INSERT INTO `sys_log` VALUES ('622', '1', 'admin', '删除菜单', '4', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:48:58');
INSERT INTO `sys_log` VALUES ('623', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:08');
INSERT INTO `sys_log` VALUES ('624', '1', 'admin', '删除菜单', '3', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:13');
INSERT INTO `sys_log` VALUES ('625', '1', 'admin', '删除菜单', '5', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:16');
INSERT INTO `sys_log` VALUES ('626', '1', 'admin', '删除菜单', '2', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:18');
INSERT INTO `sys_log` VALUES ('627', '1', 'admin', '删除菜单', '6', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:32');
INSERT INTO `sys_log` VALUES ('628', '1', 'admin', '删除菜单', '6', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:38');
INSERT INTO `sys_log` VALUES ('629', '1', 'admin', '删除菜单', '7', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:44');
INSERT INTO `sys_log` VALUES ('630', '1', 'admin', '删除菜单', '4', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:48');
INSERT INTO `sys_log` VALUES ('631', '1', 'admin', '删除菜单', '4', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:54');
INSERT INTO `sys_log` VALUES ('632', '1', 'admin', '删除菜单', '4', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:49:59');
INSERT INTO `sys_log` VALUES ('633', '1', 'admin', '删除菜单', '2', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:50:01');
INSERT INTO `sys_log` VALUES ('634', '1', 'admin', '删除菜单', '6', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:52:08');
INSERT INTO `sys_log` VALUES ('635', '1', 'admin', '删除菜单', '3', 'com.bootdo.system.controller.MenuController.remove()', null, '127.0.0.1', '2019-09-19 08:52:10');
INSERT INTO `sys_log` VALUES ('636', '1', 'admin', '登录', '39', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 09:46:32');
INSERT INTO `sys_log` VALUES ('637', '1', 'admin', '请求访问主页', '33', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 09:46:32');
INSERT INTO `sys_log` VALUES ('638', '1', 'admin', '登录', '36', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 09:55:15');
INSERT INTO `sys_log` VALUES ('639', '1', 'admin', '请求访问主页', '31', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 09:55:15');
INSERT INTO `sys_log` VALUES ('640', '1', 'admin', '登录', '5', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 09:57:15');
INSERT INTO `sys_log` VALUES ('641', '1', 'admin', '请求访问主页', '12', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 09:57:15');
INSERT INTO `sys_log` VALUES ('642', '1', 'admin', '登录', '5', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 09:59:03');
INSERT INTO `sys_log` VALUES ('643', '1', 'admin', '请求访问主页', '11', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 09:59:03');
INSERT INTO `sys_log` VALUES ('644', '1', 'admin', '请求访问主页', '10', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 09:59:39');
INSERT INTO `sys_log` VALUES ('645', '1', 'admin', '请求访问主页', '7', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:00:29');
INSERT INTO `sys_log` VALUES ('646', '1', 'admin', '请求访问主页', '7', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:00:59');
INSERT INTO `sys_log` VALUES ('647', '1', 'admin', '请求访问主页', '9', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:01:00');
INSERT INTO `sys_log` VALUES ('648', '1', 'admin', '请求访问主页', '26', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:01:49');
INSERT INTO `sys_log` VALUES ('649', '1', 'admin', '请求访问主页', '5', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:02:22');
INSERT INTO `sys_log` VALUES ('650', '1', 'admin', '请求访问主页', '7', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:02:40');
INSERT INTO `sys_log` VALUES ('651', '1', 'admin', '请求访问主页', '13', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:03:00');
INSERT INTO `sys_log` VALUES ('652', '1', 'admin', '请求访问主页', '5', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:03:06');
INSERT INTO `sys_log` VALUES ('653', '1', 'admin', '请求访问主页', '6', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:03:50');
INSERT INTO `sys_log` VALUES ('654', '1', 'admin', '请求访问主页', '7', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:04:02');
INSERT INTO `sys_log` VALUES ('655', '1', 'admin', '登录', '37', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:05:56');
INSERT INTO `sys_log` VALUES ('656', '1', 'admin', '请求访问主页', '37', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:05:56');
INSERT INTO `sys_log` VALUES ('657', '1', 'admin', '登录', '52', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:10:38');
INSERT INTO `sys_log` VALUES ('658', '1', 'admin', '请求访问主页', '41', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:10:38');
INSERT INTO `sys_log` VALUES ('659', '1', 'admin', '登录', '40', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:13:35');
INSERT INTO `sys_log` VALUES ('660', '1', 'admin', '请求访问主页', '40', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:13:35');
INSERT INTO `sys_log` VALUES ('661', '1', 'admin', 'error', null, 'http://localhost/sys/user/list', 'java.lang.NullPointerException', null, '2019-09-19 10:14:24');
INSERT INTO `sys_log` VALUES ('662', '1', 'admin', '登录', '43', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:17:10');
INSERT INTO `sys_log` VALUES ('663', '1', 'admin', '请求访问主页', '38', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:17:10');
INSERT INTO `sys_log` VALUES ('664', '1', 'admin', '编辑角色', '5', 'com.springboot_demogboot_demo.system.controller.RoleController.edit()', null, '127.0.0.1', '2019-09-19 10:18:27');
INSERT INTO `sys_log` VALUES ('665', '1', 'admin', '编辑用户', '26', 'com.springboot_demogboot_demo.system.controller.UserController.edit()', null, '127.0.0.1', '2019-09-19 10:18:40');
INSERT INTO `sys_log` VALUES ('666', '1', 'admin', '编辑用户', '11', 'com.springboot_demogboot_demo.system.controller.UserController.edit()', null, '127.0.0.1', '2019-09-19 10:18:48');
INSERT INTO `sys_log` VALUES ('667', '1', 'admin', '登录', '37', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:20:26');
INSERT INTO `sys_log` VALUES ('668', '1', 'admin', '请求访问主页', '33', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:20:26');
INSERT INTO `sys_log` VALUES ('669', '1', 'admin', 'error', null, 'http://localhost/index', 'org.springframework.web.HttpRequestMethodNotSupportedException: Request method \'POST\' not supported', null, '2019-09-19 10:20:32');
INSERT INTO `sys_log` VALUES ('670', '1', 'admin', '请求访问主页', '8', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:20:33');
INSERT INTO `sys_log` VALUES ('671', '1', 'admin', '请求访问主页', '10', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:21:00');
INSERT INTO `sys_log` VALUES ('672', '1', 'admin', '请求访问主页', '10', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:21:07');
INSERT INTO `sys_log` VALUES ('673', '1', 'admin', '请求访问主页', '11', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:21:08');
INSERT INTO `sys_log` VALUES ('674', '1', 'admin', '请求访问主页', '7', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:21:22');
INSERT INTO `sys_log` VALUES ('675', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：follow_table', null, '2019-09-19 10:23:03');
INSERT INTO `sys_log` VALUES ('676', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：follow_table', null, '2019-09-19 10:25:00');
INSERT INTO `sys_log` VALUES ('677', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：follow_table', null, '2019-09-19 10:25:58');
INSERT INTO `sys_log` VALUES ('678', '1', 'admin', '登录', '35', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:26:43');
INSERT INTO `sys_log` VALUES ('679', '1', 'admin', '请求访问主页', '31', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:26:43');
INSERT INTO `sys_log` VALUES ('680', '1', 'admin', '登录', '34', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:28:53');
INSERT INTO `sys_log` VALUES ('681', '1', 'admin', '请求访问主页', '30', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:28:53');
INSERT INTO `sys_log` VALUES ('682', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：follow_table', null, '2019-09-19 10:30:00');
INSERT INTO `sys_log` VALUES ('683', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'java.lang.NullPointerException', null, '2019-09-19 10:31:39');
INSERT INTO `sys_log` VALUES ('684', '1', 'admin', '登录', '36', 'com.springboot_demogboot_demo.system.controller.LoginController.ajaxLogin()', null, '127.0.0.1', '2019-09-19 10:31:56');
INSERT INTO `sys_log` VALUES ('685', '1', 'admin', '请求访问主页', '33', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:31:56');
INSERT INTO `sys_log` VALUES ('686', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：feedback_table', null, '2019-09-19 10:33:48');
INSERT INTO `sys_log` VALUES ('687', '1', 'admin', '请求访问主页', '8', 'com.springboot_demogboot_demo.system.controller.LoginController.index()', null, '127.0.0.1', '2019-09-19 10:34:50');
INSERT INTO `sys_log` VALUES ('688', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：feedback_table', null, '2019-09-19 10:39:05');
INSERT INTO `sys_log` VALUES ('689', '1', 'admin', 'error', null, 'http://localhost/common/generator/batchCode', 'com.springboot_demogboot_demo.common.utils.BDException: 渲染模板失败，表名：follow_table', null, '2019-09-19 10:42:24');
...
-- Records of sys_task
-- ----------------------------
INSERT INTO `sys_task` VALUES ('2', '0/10 * * * * ?', 'run1', '1', '', '4028ea815a3d2a8c015a3d2f8d2a0002', 'com.springboot_demogboot_demo.common.task.WelcomeJob', '2017-05-19 18:30:56', '1', 'group1', '2017-05-19 18:31:07', null, '', 'welcomJob');
